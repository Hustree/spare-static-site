...
var buildScripts = function (done) {
    ...
    return src(paths.scripts.input).pipe(flatmap(function (stream, file) {
...
var copyImages = function (done) {
    ...
    // Fonts static files
    return src(paths.img.input).pipe(dest(paths.img.output));
};
...
// Default task
// gulp
exports.default = series(cleanDist, parallel(buildScripts, lintScripts, buildStyles, buildSVGs, copyFiles, copyFonts, copyImages));
